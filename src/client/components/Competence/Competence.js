...
export default class Competence extends Component {
  ...
  render() {
    return (
      ...
      <h2 className="title-competence">Competences</h2>
      <div className="item-competence"><u>Languague Informatique :</u> JavaScript, HTML, CSS, PHP, Python, SQL.</div>
      ...
      <div className="item-competence"><u>Systeme d'exploitation :</u> Windows : XP, 7, 8, 10, Serveur 2008, 2012 R2, 2016.<br/>Linux : Debian, Unbuntu, Mandriva, Cent-OS.<br/>macOS : Mojave, High Sierra, Sierra, El Capitan, Yosemite, Maverick.</div>
      ...
      <div className="item-competence last-competence"><u>Anglais :</u> Intermediaire</div>
